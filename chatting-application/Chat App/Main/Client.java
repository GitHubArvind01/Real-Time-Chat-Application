...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/friProfile.png"));
        ...
        JLabel name = new JLabel("Friend 2");
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            JPanel p2 = formatLabel(out, true); // Sent message
            ...
            dout.writeUTF(out); // Send to server
    ...
    public static JPanel formatLabel(String message, boolean isSent) {
        ...
        JLabel output = new JLabel("<html><p style=\"width: 150px\">" + message + "</p></html>") {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2.setColor(isSent ? new Color(37, 211, 102) : new Color(115, 115, 115)); // Light Blue for sent, Light Gray for received
        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    JPanel panel = formatLabel(msg, false); // Received message
